...
<li><NavLink to="/" className={({isActive}) => isActive? 'border-2  bg-green-100 text-green-500' : '' }>Home</NavLink></li>
...
<li><NavLink to="/buy" className={({isActive}) => isActive? 'border-2 bg-green-100  text-green-500' : '' }>Buy on Amazon</NavLink></li>
    ...
    return (
        <div className="lg:container mx-auto  navbar bg-base-100  ">
  <div className="navbar-start ">
    ...
    <Link to="/home" className="btn btn-ghost text-xl lg:text-5xl font-bold">Book Vibe</Link>
  </div>
